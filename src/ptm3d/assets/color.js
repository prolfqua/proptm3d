...
/**
 * Map a log2FC value onto a blue-white-red gradient.
 *
 * Matches the PyMOL exporter's convention: blue = down, white = unchanged, red = up.
 *
...
export function foldChangeColor (log2fc) {
  ...
  return log2fc > 0 ? `#ff${hex(faded)}${hex(faded)}` : `#${hex(faded)}${hex(faded)}ff`
}
